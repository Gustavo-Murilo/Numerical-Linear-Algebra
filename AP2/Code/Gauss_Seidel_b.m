function [x_k, k, norma_dif, norma_residuo] = Gauss_Seidel_b(A, b, x_0, E, M, tipo_norma)
% ////////////////////////////////////////////////////////////////////
...
% ////////////////////////////////////////////////////////////////////
  ...
  while k < M
    ...
    % Resolvendo (L+D)*x_k = -U*x_(k-1) + b
    v_GS = -U * x_0 + b;
    x_k = Resolve_L(LD, v_GS); 
